...
import { suffixes } from '../../data';

const SuffixesPage = ({}) => {
  const randomIndex = () => Math.floor(Math.random() * (suffixes.length ?? 0));
  ...
  const [title, meaning, examples] = suffixes[index];
